...
function generateJewellList(obj) {
    ...
    str += '<div class="acct fLeft">';
    str += '<center>';
    str += '<a href="'+ DOMAIN + 'upload-image/jid-'+ obj['id'] +'" target="_blank"><div class="uploadBtn poR ripplelink"></div></a>';
    str += '<div class="deltBtn poR ripplelink" onclick="deleteProduct(' + obj['id'] + ',this)"></div>';
...
function generatBullionsList(obj) {
    ...
    str += '<div class="acct fLeft">';
    str += '<center>';
    str += '<a href="'+ DOMAIN + 'upload-image/bid-'+ obj['id'] +'" target="_blank"><div class="uploadBtn poR ripplelink"></div></a>';
    str += '<div class="deltBtn poR ripplelink" onclick="deleteProduct(' + obj['id'] + ',this)"></div>';
