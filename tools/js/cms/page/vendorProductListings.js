...
function generateDiamondList(obj) {
    ...
    str += '<center>';
    str += '<a href="'+ DOMAIN + 'upload-image/pid-'+ obj['id'] +'" target=""><div class="uploadBtn poR ripplelink"></div></a>';
...
function generateJewellList(obj) {
    ...
    str += '<div class="acct fLeft">';
    str += '<center>';
    str += '<a href="'+ DOMAIN + 'upload-image/jid-'+ obj['id'] +'" target=""><div class="uploadBtn poR ripplelink"></div></a>';
    str += '<div class="deltBtn poR ripplelink" onclick="deleteProduct(' + obj['id'] + ',this)"></div>';
...
function generatBullionsList(obj) {
    ...
    str += '<div class="acct fLeft">';
    str += '<center>';
    str += '<a href="'+ DOMAIN + 'upload-image/bid-'+ obj['id'] +'" target=""><div class="uploadBtn poR ripplelink"></div></a>';
    str += '<div class="deltBtn poR ripplelink" onclick="deleteProduct(' + obj['id'] + ',this)"></div>';
