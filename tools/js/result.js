                        ...
                        html += '<div class="b2bPricesCont fLeft">';
                            html += '<div class="prdPrice fLeft">';
                                html += '<div class="detComm">';
                                    ...
                                    var price = Math.ceil(((vl.pprice * dollarValue) * vl.attributes.carat));
                                    html += '<div class="detValue fmOpenB fLeft"><span class="fLeft rupeeImg"></span>'+ common.IND_money_format(price) +'</div>';
                                html += '</div>';
                            html += '</div>';
                            html += '<div class="prdPrice fLeft">';
                                html += '<div class="detComm">';
                                    ...
                                    { price = 'N/A'; }
                                    html += '<div class="+"><span class="fLeft rupeeImg"></span>'+ price +'</div>';
                                html += '</div>';
                            html += '</div>';
                        html += '</div>';
...
//						html += '</div>';
            ...
            $.each(data.results.products, function(i, vl) {
                ...
                var price = Math.ceil(((vl.pprice * dollarValue) * vl.attributes.carat));
                html += '<div class="detValue fmOpenB fLeft"><span class="fLetf rupeeImg mTop14"></span>'+ common.IND_money_format(price) +'</div>';
                html += '</div>';
                html += '</div>';
                html += '</a>';
                html += '<div class="prdActions fLeft">';
						...
						html += '<div class="prdCommDiv fLeft transition100">';
								...
								html += '<div class="prdPrice fLeft">';
									html += '<div class="detComm">';
										...
										html += '<div class="detValue fmOpenB fLeft"><span class="fLeft rupeeImg jhguylgtyu"></span>'+ common.IND_money_format(price) +'</div>';
									html += '</div>';
								html += '</div>';
							html += '</a>';
							html += '<div class="prdActions fLeft">';
						...
						html += '<div class="prdCommDiv fLeft transition100">';
                                                ...
                                                html += '<div class="prdPrice fLeft">';
                                                        html += '<div class="detComm">';
                                                                ...
                                                                var price = Math.ceil(((vl.pprice * dollarValue) * vl.attributes.carat));
                                                                html += '<div class="detValue fmOpenB fLeft"><span class="fLeft rupeeImg mTop14"></span>'+common.IND_money_format(price)+'</div>';
                                                        html += '</div>';
                                                html += '</div>';
                                                html += '</a>';
                                                html += '<div class="prdActions fLeft">';
							...
							html += '<div class="prdPrice fLeft">';
								html += '<div class="detComm">';
									html += '<div class="detLabel fmOpenB fLeft">PRICE</div>';
                                                                        ...
                                                                        html += '<div class="detValue fmOpenB fLeft"><span class="fLeft rupeeImg mTop14"></span>'+ common.IND_money_format(metal_price)+'</div>';
								html += '</div>';
							html += '</div>';
                                                        html += '</a>';
							html += '<div class="prdActions fLeft">';
				...
				html += '<div class="prdComm fLeft transition100">';
					html += '<div class="prdCommDiv fLeft transition100">';
						...
						html += '<div class="prdPrice fLeft">';
							html += '<div class="detComm">';
								html += '<div class="detLabel fmOpenB fLeft">BEST PRICE</div>';
								html += '<div class="detValue fmOpenB fLeft"><span class="fLeft rupeeImg mTop14"></span>8,28,5888</div>';
							html += '</div>';
						html += '</div>';
						html += '<div class="prdActions fLeft">';
