...
class sendingMail extends DB
{
    ...
    function __construct($db)
    {
        ...
        function vendor_cont()
        {
          ...
          $str .='<div style="text-align: left; vertical-align: middle;padding-bottom:5px;">For any Assistance call <a href="tel:+022-32623263" style="text-decoration: none; color:#888; font-weight: bold;">+022-32623263</a> </div>';
          $str .='</div>';
          $str .='</div>';
          $str .='<div style="color:#666; font-size: 0.8em;">- The IftoSi.com Team</div>';
          $str .='</div>';
